...
# with command line options: step2 --conditions auto:phase2_realistic_T15 -n 10 --era Phase2C9 --eventcontent FEVTDEBUGHLT,MINIAODSIM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,RECOSIM,PAT --datatier GEN-SIM-RECO,MINIAODSIM --geometry Extended2026D49 --filein file:SingleElectron_DIGIRAW.root --fileout file:SingleElectron_RECO.root --no_exec --python_filename SingleElectronPt10_RECO.py
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:SingleElectron_DIGIRAW.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SingleElectron_RECO.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SingleElectron_RECO_inMINIAODSIM.root'),
